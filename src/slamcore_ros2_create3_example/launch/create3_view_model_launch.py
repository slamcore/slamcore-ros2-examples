"""
Visualize the transforms of the iRobot Create 3 URDF/Xacro model along with the Odometry Base <-> Slamcore
...
def generate_launch_description():
    ...
    default_urdf_file = share_dir / "descriptions" / "slamcore-create3.urdf.xacro"
