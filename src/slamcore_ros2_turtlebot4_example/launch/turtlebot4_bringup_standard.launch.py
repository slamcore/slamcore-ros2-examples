...
Bring up TurtleBot 4 launch file, diagnostics, robot description, cmd_vel_mux
and teleop with a single launch file - to be used on boot.
...
def generate_launch_description():
    ...
    add_all_actions(
        ...
        IncludeLaunchDescription(
            launchfile_for(
                "slamcore_ros2_turtlebot4_example", "turtlebot4_teleop_joy_launch.py"
            ),
        ),
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={"model": "standard"}.items(),
        ),
