...
def generate_launch_description():
    ...
    share_dir = get_package_share_path("slamcore_ros2_turtlebot4_example")

    # non-editable config variables -----------------------------------------------------------
    default_demo_params_file = share_dir / "config" / "turtlebot4-cmd-vel-mux.yaml"
    ...
    add_all_actions(
        Node(
            ...
            output="screen",
            parameters=[cfg.cmd_vel_params_file.cfg],
            on_exit=Shutdown(),
        ),
        ld=ld,
    )
